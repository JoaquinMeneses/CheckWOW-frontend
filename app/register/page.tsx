...
const Register = () => {
  return (
    <div className="min-h-screen bg-[url('/cinematic_render_scourge_full.webp')] bg-no-repeat bg-cover	flex items-center justify-center p-4">
        ...
        <div className="bg-black w-full rounded-lg p-8 mb-8">
          ...
          <form className="flex flex-col gap-4">
            ...
            <span className="flex items-center justify-center gap-2 text-white">
              ¿Ya tienes cuenta?
              <Link href="/login">
                <p className="text-blue-500">Inicia sesión</p>
              </Link>
            </span>
          </form>
        </div>
